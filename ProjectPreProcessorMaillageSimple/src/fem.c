...
double geoSizeDefault(double x, double y) { return theGeometry.h1; }
...
// J'ai mis le geoMeshImport du devoir 2 sinon marchait pas avec la découpe du maillage
void geoMeshImport2() {
    int ierr;
