...
int main(void) {
  ...
  theGeometry->h1 = 2.0;  // petit changement par rapport à la version donnée par les professeurs. On a 2 h donc h1 et h2 au lieu d'uniquement h
