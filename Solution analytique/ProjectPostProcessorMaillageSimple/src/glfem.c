...
void glfemMessage(char *message) {
  glColor3f(1.0, 0.0, 0.0);
  glfemDrawMessage(20, 630, message);
}

void glfemMessage2(char *message) {
  glColor3f(1.0, 0.0, 0.0);
  glfemDrawMessage(20, 610, message);
}

GLFWwindow *glfemInit(char *theWindowName) {
  glfwInit();
  GLFWwindow *window = glfwCreateWindow(650, 650, "Simple example with graphics", NULL, NULL);
  glfwSetKeyCallback(window, glfemKeyCallback);
  glfwMakeContextCurrent(window);
  glfemSetRasterSize(650, 650);
