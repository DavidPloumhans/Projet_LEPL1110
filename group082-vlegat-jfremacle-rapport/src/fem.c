...
void geoFinalize() 
{
    ...
    // j'ai retiré la ligne correspondant à un quelque chose de lié à gmsh
}
...
void geoMeshRead(const char *filename)  // ce qu'on va utiliser pour importer notre maillage
{
